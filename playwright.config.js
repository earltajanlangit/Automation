const { defineConfig } = require('@playwright/test');
  ...
  module.exports = defineConfig({
    ...
    actionTimeout: 600000, // Set timeout for actions (10 seconds)
    navigationTimeout: 600000, // Set timeout for navigations (15 seconds)
  },
  projects: [
    // {
    //   name: 'Chromium',
  ...
  timeout: 600000, // Set global timeout for tests (30 seconds)
  expect: {
    timeout: 600000, // Timeout for expect assertions (5 seconds)
  },
});
